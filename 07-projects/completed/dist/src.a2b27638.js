...
function fetchImages() {
  ...
  return fetch(url).then(res => res.json()).then(data => data.collection.items).catch(error => console.error(error));
}
},{"./state":"src/state.js"}],"node_modules/moment/moment.js":[function(require,module,exports) {
var define;
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/components/modal/index.css":[function(require,module,exports) {
...
function updateModalContent() {
  const image = _state.state.images[_state.state.currentImage];
  const title = image.data[0].title;
  const url = image.links[0].href;
  const description = stripHtml(image.data[0].description);
  const date = (0, _moment.default)(image.data[0].date_created).format(`MMM. Do, YYYY`);
...
function open() {
  ...
  container.insertAdjacentHTML("beforeend", modal()); // Update the content for the modal

  updateModalContent(); // Initialize the event listeners
...
function init() {
  ...
  document.addEventListener("keyup", handleKeys); // Add event listener for clicking on overlay

  const closeBtn = document.querySelector(`#modal #close`);
  closeBtn.addEventListener("click", close); // Add event listener for clicking on overlay

  const overlay = document.querySelector(`#overlay`);
  overlay.addEventListener("click", handleCloseClick); // Add event listener to prev and next links
...
function handlePrev(event) {
  ...
  if (_state.state.currentImage - 1 < 0) {
    (0, _state.setState)(`currentImage`, _state.state.images.length - 1);
  } else {
    (0, _state.setState)(`currentImage`, _state.state.currentImage - 1);
  }
...
function handleNext(event) {
  ...
  if (_state.state.currentImage + 1 >= _state.state.images.length) {
    (0, _state.setState)(`currentImage`, 0);
  } else {
    (0, _state.setState)(`currentImage`, _state.state.currentImage + 1);
  }
...
},{"../../state":"src/state.js","moment":"node_modules/moment/moment.js","./index.css":"src/components/modal/index.css"}],"src/components/lightbox/index.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
},{"../../state":"src/state.js","../modal":"src/components/modal/index.js","./index.css":"src/components/lightbox/index.css"}],"src/components/search/index.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
